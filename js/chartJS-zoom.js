...
!(function (e, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : ((e =
        'undefined' != typeof globalThis
          ? globalThis
          : e || self).ChartZoom = n(e.Chart, e.Hammer, e.Chart.helpers))
})(this, function (e, n, t) {
  'use strict'
  function o (e) {
  ...
  function h (e, { min: n, max: t }, o, a = !1) {
    const i = u(e.chart),
    ...
    return (
      (l.min = n),
      (l.max = t),
      (i.updatedScaleLimits[e.id] = { min: n, max: t }),
  ...
  function g (e, n, t, o = !1) {
    const { min: a, max: i, options: c } = e,
      ...
      l = x[r] || 0,
      s = e.getValueForPixel(e.getPixelForValue(a + l) - n),
      m = e.getValueForPixel(e.getPixelForValue(i + l) - n),
      { min: u = -1 / 0, max: d = 1 / 0 } = (o && t && t[e.axis]) || {}
    return (
  ...
  function S (e, n, o = 'none') {
    const { x: a = 1, y: i = 1, focalPoint: c = w(e) } =
    ...
    t.each(g || e.scales, function (e) {
      e.isHorizontal() && p
        ? k(e, a, c, m)
        : !e.isHorizontal() && x && k(e, i, c, m)
    }),
      e.update(o),
      t.callback(d.onZoom, [{ chart: e }])
  }
  function P (e, n, t) {
    ...
    return (
      t.each(e.scales, function (e) {
        const i = (function (e, n) {
          ...
          const { min: a, max: i } = o
          return (
            t.valueOrDefault(i.options, i.scale) -
            t.valueOrDefault(a.options, a.scale)
          )
        })(n, e.id)
        if (i) {
  ...
  function Z (e, n, o, a = 'none') {
    const { x: i = 0, y: c = 0 } = 'number' == typeof n ? { x: n, y: n } : n,
      r = u(e),
      {
    ...
    t.each(o || e.scales, function (e) {
      ...
      e.update(a),
      t.callback(f, [{ chart: e }])
  }
  function L (e) {
    const n = u(e),
      t = {}
    for (const o of Object.keys(e.scales)) {
      const { min: e, max: a } = n.originalScaleLimits[o] || {
        min: {},
        max: {}
      }
      t[o] = { min: e.scale, max: a.scale }
    }
    return t
  }
  function R (e, n) {
    const { handlers: t } = u(e),
      o = t[n]
  ...
  function X (e, n) {
    ...
    if (c(i(a), n) || r(i(l.drag), n))
      return t.callback(l.onZoomRejected, [{ chart: e, event: n }])
    !1 !== T(e, n, l) && ((o.dragStart = n), Y(e, e.canvas, 'mousemove', O))
  }
  function D (e, n, t, o) {
    const { left: a, top: i } = t.target.getBoundingClientRect(),
      c = l(n, 'x', e),
      r = l(n, 'y', e)
    let {
      top: s,
    ...
    c &&
      ...
      r &&
        ((s = Math.min(t.clientY, o.clientY) - i),
        (d = Math.max(t.clientY, o.clientY) - i))
    const p = u - m,
      x = d - s
    return {
      left: m,
  ...
  function F (e, n) {
    ...
    if (
      !(function (e, n, o) {
        if (r(i(o.wheel), n))
          t.callback(o.onZoomRejected, [{ chart: e, event: n }])
        else if (
          !1 !== T(e, n, o) &&
    ...
    return function (o, a) {
      ...
      return (
        ...
        !(
          ...
          (t.callback(l.onPanRejected, [{ chart: e, event: a }]), !1)
      )
    }
  }
  function B (e, n, t) {
  ...
  function K (e, n, t) {
    ...
    o &&
      ((n.panning = !0),
      Z(e, { x: t.deltaX - o.x, y: t.deltaY - o.y }, n.panScales),
  ...
  function q (e, n) {
    ...
    r &&
      ...
      c &&
        c.enabled &&
        (l.add(new a.default.Pan({ threshold: c.threshold, enable: V(e, o) })),
        l.on('panstart', n =>
          (function (e, n, o) {
            const {
              enabled: a,
            ...
            if (!1 === t.callback(c, [{ chart: e, event: o, point: m }]))
              return t.callback(r, [{ chart: e, event: o }])
            ;(n.panScales = i && s(i, m, e)),
              (n.delta = { x: 0, y: 0 }),
              clearTimeout(n.panEndTimeout),
              K(e, n, o)
          })(e, o, n)
        ),
        l.on('panmove', n => K(e, o, n)),
        l.on('panend', () =>
          (function (e, n) {
            ;(n.delta = null),
              n.panning &&
  ...
  var W = {
        ...
        (e.resetZoom = n =>
          (function (e, n = 'default') {
            ...
            t.each(e.scales, function (e) {
              const n = e.options
              a[e.id]
                ? ((n.min = a[e.id].min.options), (n.max = a[e.id].max.options))
                : (delete n.min, delete n.max)
            }),
              e.update(n),
              t.callback(o.options.zoom.onZoomComplete, [{ chart: e }])
          })(e, n)),
        (e.getZoomLevel = () => C(e)),
        (e.getInitialScaleBounds = () => L(e)),
        (e.isZoomedOrPanned = () =>
          (function (e) {
            const n = L(e)
            for (const t of Object.keys(e.scales)) {
              const { min: o, max: a } = n[t]
    ...
    beforeUpdate: function (e, n, t) {
      ;(u(e).options = t),
        (function (e, n) {
          ...
          o.enabled
            ? (Y(e, t, 'wheel', F), H(e, 'onZoomComplete', i, 250))
            : R(e, 'wheel'),
            a.enabled
              ? (Y(e, t, 'mousedown', X), Y(e, t.ownerDocument, 'mouseup', E))
    ...
    beforeDatasetsDraw: function (e, n, t) {
      ...
      if (a) {
        const { left: n, top: i, width: c, height: r } = D(
            e,
            t.zoom.mode,
            o,
            a
